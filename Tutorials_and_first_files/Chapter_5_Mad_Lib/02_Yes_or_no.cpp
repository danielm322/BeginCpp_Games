...
// Hint: in the function prototypes, we don't actually need the parameter names, but we do need the parameter types
// but in general it's a good idea to include both type and names in the prototype
int main()
{
